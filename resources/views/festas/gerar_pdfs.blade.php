...
<html lang="pt-br">
    ...
    <div class="header-container">
        <img src="{{asset('storage/uploads/lzYBrAWTqXmYH5mHDQsBErPabLaZ9ZjcIU8eGvLv.png')}}" alt="Cabeçalho da Festa do Divino">
    </div>

    <div class="page-container">
        <div class="watermark">
            <img src="{{asset('storage/uploads/Wp8NJtTtOtoxWWjWcbmzTkkN8YorKW5LT9I6kkQm.png')}}" alt="Marca D'água">
        </div>
                ...
                <table class="bingo-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>22</td>
                            <td>
                                <img src="{{asset('storage/uploads/Qd9YnMvp4AxkO7F7p5yNu0L0Re6Zl3gsS4Urdb79.png')}}" alt="Sua Imagem">
                            </td>
                            <td>51</td>
                            <td>70</td>
                        </tr>
